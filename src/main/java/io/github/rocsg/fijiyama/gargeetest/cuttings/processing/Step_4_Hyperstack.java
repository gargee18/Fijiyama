...
public class Step_4_Hyperstack implements PipelineStep{
    ...
    public static ImagePlus createHyperStacks(String specimen) {
        ImagePlus imgB001 = IJ.openImage(mainDir + specimen + "/raw/" + specimen + "_J001_aligned.tif");
        ImagePlus imgB029 = IJ.openImage(mainDir + specimen + "/outputs/" + specimen + "_001_029_TransformedImage_Reg_Aligned.tif");
        ImagePlus imgB077 = IJ.openImage(mainDir + specimen + "/outputs/" + specimen + "_001_077_TransformedImage_Reg_Aligned.tif");
        ImagePlus imgB141 = IJ.openImage(mainDir + specimen + "/outputs/" + specimen + "_001_0141_TransformedImage_Reg_Aligned.tif");
        ...
        // hyperFrame.show();
        IJ.saveAsTiff(hyperFrame, mainDir + specimen + "/hyperimage/" + specimen + "_Hyperstack.tif");
        return hyperFrame;
    }
